...
const Banner = () => {
    ...
    return (
        <div className="lg:px-56 px-10 py-10 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
                ...
                <div className="flex mt-8 gap-2">
                    <div className="flex items-center justify-center">
                        <div className="flex space-x-4">
                            <a href="https://www.linkedin.com/in/ruth-de-le%C3%B3n-2a5566203/" className="text-orange-200 hover:text-orange-100 rounded-full glow p-2" target="_blank" rel="noopener noreferrer">
                                <FaLinkedinIn className="text-[28px] glow-icon" />
                            </a>
                            <a href="https://github.com/Anaru03" className="text-orange-200 hover:text-orange-100 rounded-full glow p-2" target="_blank" rel="noopener noreferrer">
                                <AiFillGithub className="text-[28px] glow-icon" />
                            </a>
                            <a href="https://twitter.com/anai_ruth" className="text-orange-200 hover:text-orange-100 rounded-full glow p-2" target="_blank" rel="noopener noreferrer">
            ...
            <img data-aos='fade-up' src={ImageInit} alt="ImageInit" width={290} height={290} className="rounded-full border-2 p-1 border-violet-400 image_glow" />
        </div>
    );
};
